...
import {HoverCardContent, HoverCard, HoverCardTrigger} from "@/components/atoms/hover-card.tsx";
import ProbeStatus from "@/features/probes/components/probe-status.tsx";
...
export default function ProbeMonitorChartBar({monitors}: { monitors: Monitor[] }) {
