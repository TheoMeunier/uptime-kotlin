...
import {Select, SelectValue, SelectContent, SelectItem, SelectTrigger} from "@/components/atoms/select.tsx";
...
export default function ProbeChart({monitors}: { monitors: Monitor[] }) {
    ...
    const getFilteredData = () => {
        ...
        const intervalMinutes = hoursToSubtract >= 24 * 7 ? 120 : hoursToSubtract >= 24 ? 60 : hoursToSubtract >= 6 ? 30 : 15;

        for (let d = new Date(startDate); d <= referenceDate; d = new Date(d.getTime() + intervalMinutes * 60000)) {
            ...
            <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
                ...
                <Select value={timeRange} onValueChange={setTimeRange}>
                    ...
                    <SelectContent className="rounded-xl">
                        ...
                        <SelectItem value="3h" className="rounded-lg">Last 3 hours</SelectItem>
