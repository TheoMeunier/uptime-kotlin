			...
			<CardContent className="p-0">
                ...
                `}
                    ...
                    `}
										...
										<div className={`flex items-center gap-1 px-2 py-0.5 rounded-full bg-gray-50 border`}>
											<Activity className={`w-3 h-3 ${getResponseTimeColor(monitor.response_time)}`} />
											<span className={`text-xs font-medium ${getResponseTimeColor(monitor.response_time)}`}>
