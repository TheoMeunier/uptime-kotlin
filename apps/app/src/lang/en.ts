const en = {
	...
	monitors: {
		...
		description: {
			...
			remove: 'This action is irreversible. All associated data will be permanently deleted',
			check_now_disabled: 'Resume this monitor to run a check.',
		...
		alerts: {
			...
			check_now: 'Check requested, the result will appear shortly',
			check_now_already_running: 'A check is already running for this monitor',
