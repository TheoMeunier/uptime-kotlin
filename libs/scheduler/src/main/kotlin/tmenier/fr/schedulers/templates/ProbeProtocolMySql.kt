...
@ApplicationScoped
class ProbeProtocolMySql(
    private val healthCheck: MySqlHealthCheck,
) : ProbeProtocolAbstract<ProbeContent.MySql>() {
    override fun execute(
        ...
        return try {
            ...
            ProbeResult(
                ...
                message = "MySQL/MariaDB connection successful in ${responseTime}ms",
            ...
            ProbeResult(
                ...
                message = "MySQL/MariaDB connection failed: ${error.message}",
                runAt = getRunAt(start),
            )
        }
    }

    override fun getProtocolType() = ProbeProtocol.MYSQL.name
