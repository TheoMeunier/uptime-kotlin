...
@ApplicationScoped
class ProbeProtocolKafka(
    private val healthCheck: KafkaHealthCheck,
) : ProbeProtocolAbstract<ProbeContent.Kafka>() {
    override fun execute(
        ...
        return try {
            ...
            ProbeResult(
                ...
                message = "Kafka message produced successfully in ${responseTime}ms",
            ...
            ProbeResult(
                ...
                message = "Kafka producer failed: ${error.message}",
                runAt = getRunAt(start),
            )
        }
    }

    override fun getProtocolType() = ProbeProtocol.KAFKA.name
